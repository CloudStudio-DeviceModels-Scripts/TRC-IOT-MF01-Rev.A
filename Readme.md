...
# Parsing + Configuration Script – TRC-IOT-MF01 - Rev. A

This **Parsing + Configuration** script is designed for the **TRC-IOT-MF01** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TRC-IOT-MF01 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TRC-IOT-MF01** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
