...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Temperature sensor 1", endpointType.temperatureSensor);
  endpoints.addEndpoint("2", "Temperature sensor 2", endpointType.temperatureSensor);
  endpoints.addEndpoint("5", "Vin", endpointType.voltageSensor);
